...
const Transaction = {
  ...
  extract() {
    ...
    text += `\n\nIncome:        ${Utils.formatCurrency(incomes)}`;
    text += `\nExpense:         ${Utils.formatCurrency(expenses)}`;
...
const DOM = {
  ...
  innerHTMLTransaction(transaction, index) {
    ...
    const html = `
          ...
          <td class="edit">
              <img onclick="Transaction.edit(${index})" src="assets/img/edit.svg" alt="Edit Transaction" onload="SVGInject(this)">
          </td>
          <td class="delete">
              <img onclick="Transaction.remove(${index})" src="assets/img/trash.svg" alt="Remove Transaction" onload="SVGInject(this)">
          </td>
      `;
